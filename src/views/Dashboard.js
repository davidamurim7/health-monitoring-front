...
function Dashboard() {
  ...
  const [temperature, setTemperature] = useState(35.15);
  const [BPM, setBPM] = useState(65.2);
  const [ECG, setECG] = useState(0);
  const [oximeter, setOximeter] = useState(96);

  const [vecCharts, setVecCharts] = useState(["0", "500", "600", "1500", "1700", "2000", "2500", "2800", "2900", "3100", "3150", "3550", "3600", "3600", "2500", "2400", "1800", "1750", "1400", "1350", "700", "650", "500", "100", "50"]);
